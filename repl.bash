...
_repl() {
    ...
    case "$prev" in
    -e | --regexp | -f | --file | -d | --directories | -D | --devices | --max-depth | --exclude | --exclude-from | --exclude-dir | --include | --binary-files | --palette | --range)
        return 0
        ;;
    --color)
